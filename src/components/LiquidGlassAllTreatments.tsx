  ...
  const treatmentCategories: TreatmentCategory[] = [
    {
      ...
      treatments: [
        ...
        { name: "Gummy Smile", price: "£175 / £50 add-on" },
        { name: "Bunny Lines", price: "£175 / £50 add-on" },
        { name: "Chin Botox", price: "£175 / £50 add-on" },
        { name: "Brow Lift", price: "£175 / £50 add-on" },
    ...
    },
    {
      ...
      treatments: [
        ...
        { name: "Non Surgical Nose Job (Filler)", price: "£450", isPopular: true, link: "/non-surgical-nose-job" },
        { name: "Non Surgical Nose Job (PCL Threads)", price: "£950", link: "/non-surgical-nose-job" },
