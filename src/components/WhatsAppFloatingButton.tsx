...
const WHATSAPP_URL = `https://wa.me/${WHATSAPP_NUMBER}?text=${encodeURIComponent(
  "Hello, I'm interested in aesthetic treatments at CosmeDocs."
)}`;
...
const WhatsAppFloatingButton = () => {
  ...
  return (
    <a
      ...
      className="fixed bottom-6 left-6 z-50 w-14 h-14 rounded-full bg-[#25D366] hover:bg-[#1FBE59] text-white flex items-center justify-center shadow-lg transition-all hover:scale-105"
    >
