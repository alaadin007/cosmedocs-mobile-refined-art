    ...
    <div className="space-y-6">
      ...
      >
        ...
        <div className="space-y-4">
          ...
          <GlanceStat icon={<Syringe className="w-4 h-4" />} label="Onset" value="6–10 weeks" />
          <GlanceStat icon={<ShieldCheck className="w-4 h-4" />} label="Target" value="Gastrocnemius muscle" />
        </div>
      </motion.div>
      ...
      >
        ...
        <p className="text-white/45 text-xs font-light leading-relaxed">
          Pricing depends on muscle size, number of units required, and desired degree of slimming. A personalised treatment plan and exact cost are provided after consultation.
        </p>
      ...
      >
        ...
        <ul className="space-y-2 text-xs text-white/50 font-light">
          ...
          <li className="flex items-start gap-2">
            <span className="w-1 h-1 rounded-full bg-[#C9A050]/50 mt-1.5 flex-shrink-0" />
            Specialist body Botox experience
          </li>
          <li className="flex items-start gap-2">
            <span className="w-1 h-1 rounded-full bg-[#C9A050]/50 mt-1.5 flex-shrink-0" />
      ...
      >
        <div className="flex items-center gap-2 mb-3">
          ...
          <div>
            <p className="text-sm font-medium text-white">Jessica K.</p>
        ...
        <p className="text-sm text-white/60 leading-relaxed italic">
          "I've always been self-conscious about my calves — they looked bulky no matter how lean I got. After calf Botox at CosmeDocs, the difference is incredible. My legs look so much more proportionate."
        </p>
        <Link
          to="/testimonials"
      ...
      >
        <p className="text-sm text-white/80 mb-2">
          <span className="text-[#C9A050] font-medium">Trap Botox</span> — Shoulder slimming and neck elongation through targeted muscle reduction.
        </p>
        <Link
          to="/treatments/trap-botox/"
...
export default CalfBotoxSidebar;
