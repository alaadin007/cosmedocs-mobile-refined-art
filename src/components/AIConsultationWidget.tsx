...
const AIConsultationWidget: React.FC<AIConsultationWidgetProps> = ({ isOpen, onClose }) => {
  ...
  const loadingMessages = [
    ...
    "Did you know? Lazy skin habits and over-moisturizing can actually age you faster...",
    "Creating your personalized treatment plan...",
    "Calculating optimal treatment combinations...",
    "Preparing your aesthetic analysis..."
  ];
                    ...
                    >
                      ...
                      <div className="bg-primary/5 border border-primary/20 rounded-lg p-4 mt-6">
                        ...
                        <p className="text-xs text-muted-foreground mt-2 italic">
                          Analysis generated by Cosmedocs AI
                        </p>
                      </div>
