    ...
    <div className="space-y-6">
      ...
      >
        ...
        <p className="text-sm text-white/60 leading-relaxed italic">
          "I had a bump on my nose that always bothered me. Dr Haq smoothed it out in minutes — the result is so natural, no one can tell."
        </p>
        <Link
          to="/testimonials"
...
export default NoseFillerSidebar;
