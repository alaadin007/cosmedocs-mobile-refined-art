    ...
    <div className="space-y-6">
      ...
      >
        ...
        <div className="space-y-4">
          ...
          <GlanceStat icon={<Syringe className="w-4 h-4" />} label="Product" value="Hyaluronic acid (64mg)" />
        </div>
      </motion.div>
      ...
      >
        ...
        <div className="space-y-2">
          {[
            { tier: "First Session", price: "£350" },
            { tier: "Subsequent Sessions", price: "£300" },
          ].map((item) => (
      ...
      >
        ...
        <p className="text-sm text-white/60 leading-relaxed italic">
          "My skin literally glows now. Two sessions of Profhilo and everyone asks what I've done. It's so subtle but the difference is incredible."
        </p>
        <Link
          to="/testimonials"
...
export default ProfhiloSidebar;
