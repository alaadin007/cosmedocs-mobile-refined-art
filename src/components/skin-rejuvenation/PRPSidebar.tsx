    ...
    <div className="space-y-6">
      ...
      >
        ...
        <div className="space-y-4">
          ...
          <GlanceStat icon={<Syringe className="w-4 h-4" />} label="Product" value="Your own blood plasma" />
        </div>
      </motion.div>
      ...
      >
        ...
        <div className="space-y-2">
          {[
            { tier: "PRP Facial", price: "From £350" },
            { tier: "PRP Hair", price: "From £450" },
          ].map((item) => (
        ...
        <div className="mt-3 pt-3 border-t border-white/[0.06]">
          <p className="text-xs text-white/25">Includes blood draw & treatment</p>
        </div>
      </motion.div>
      ...
      >
        <div className="flex items-center gap-2 mb-3">
          <div className="w-8 h-8 rounded-full bg-[#C9A050] flex items-center justify-center text-black text-xs font-bold">R</div>
          <div>
        ...
        <p className="text-sm text-white/60 leading-relaxed italic">
          "Had PRP for my hair and the results have been fantastic. New growth visible within a few months. The team were so professional."
        </p>
