...
import { Star, Clock, Calendar, Activity, ArrowRight, Sparkles, FlaskConical } from "lucide-react";

const ChemicalPeelSidebar = () => {
  return (
    <div className="space-y-6">
      ...
      >
        ...
        <div className="space-y-4">
          <GlanceStat icon={<Clock className="w-4 h-4" />} label="Duration" value="20–45 minutes" />
          <GlanceStat icon={<Calendar className="w-4 h-4" />} label="Course" value="3–6 sessions" />
          <GlanceStat icon={<Activity className="w-4 h-4" />} label="Recovery" value="1–7 days peeling" />
          <GlanceStat icon={<FlaskConical className="w-4 h-4" />} label="Types" value="Light, medium, deep" />
        </div>
      </motion.div>
      ...
      >
        ...
        <div className="mt-3 pt-3 border-t border-white/[0.06]">
          <p className="text-xs text-white/25">Includes skin assessment</p>
        </div>
      </motion.div>
      ...
      >
        <div className="flex items-center gap-2 mb-3">
          <div className="w-8 h-8 rounded-full bg-[#C9A050] flex items-center justify-center text-black text-xs font-bold">N</div>
          <div>
            <p className="text-sm font-medium text-white">Natasha W.</p>
...
export default ChemicalPeelSidebar;
