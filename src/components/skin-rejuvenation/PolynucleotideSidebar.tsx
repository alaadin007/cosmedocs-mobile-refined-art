    ...
    <div className="space-y-6">
      ...
      >
        ...
        <div className="space-y-4">
          ...
          <GlanceStat icon={<Syringe className="w-4 h-4" />} label="Product" value="PDRN / Polynucleotides" />
        </div>
      </motion.div>
      ...
      >
        ...
        <div className="space-y-2">
          <div className="flex items-center justify-between text-sm">
            <span className="text-white/40">Per session</span>
            <span className="text-[#C9A050] font-medium">From £350</span>
          </div>
        </div>
        <div className="mt-3 pt-3 border-t border-white/[0.06]">
          <p className="text-xs text-white/25">Personalised plan after consultation</p>
        </div>
      </motion.div>
      ...
      >
        <div className="flex items-center gap-2 mb-3">
          <div className="w-8 h-8 rounded-full bg-[#C9A050] flex items-center justify-center text-black text-xs font-bold">L</div>
          <div>
            <p className="text-sm font-medium text-white">Laura K.</p>
            <div className="flex gap-0.5">{[...Array(5)].map((_, i) => (<Star key={i} className="w-3 h-3 text-[#C9A050] fill-[#C9A050]" />))}</div>
          </div>
        </div>
        <p className="text-sm text-white/60 leading-relaxed italic">
          "The polynucleotide treatment has genuinely transformed my skin texture. It looks healthier and more radiant than it has in years."
        </p>
...
export default PolynucleotideSidebar;
