    ...
    <div className="space-y-6">
      ...
      >
        ...
        <div className="space-y-4">
          ...
          <GlanceStat icon={<Activity className="w-4 h-4" />} label="Recovery" value="24–48 hours redness" />
          <GlanceStat icon={<Syringe className="w-4 h-4" />} label="Anaesthesia" value="Topical numbing" />
        </div>
      </motion.div>
      ...
      >
        ...
        <div className="space-y-2">
          {[
            { tier: "Single session", price: "From £250" },
            { tier: "Course of 3", price: "From £650" },
            { tier: "With PRP add-on", price: "From £450" },
          ].map((item) => (
      ...
      >
        ...
        <p className="text-xs text-white/40 leading-relaxed mb-3">
          View real patient microneedling results showing texture improvement, scar reduction, and skin rejuvenation.
        </p>
        <Link
          to="/before-after/skin-rejuvenation/"
      ...
      >
        <div className="flex items-center gap-2 mb-3">
          <div className="w-8 h-8 rounded-full bg-[#C9A050] flex items-center justify-center text-black text-xs font-bold">A</div>
          <div>
        ...
        <p className="text-sm text-white/60 leading-relaxed italic">
          "After three sessions my acne scars have faded dramatically. My skin texture is completely different — smoother, brighter, and so much more even."
        </p>
...
export default MicroneedlingSidebar;
