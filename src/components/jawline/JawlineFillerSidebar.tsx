...
import { Star, Clock, Calendar, Syringe, Activity, ArrowRight, ShieldCheck, Sparkles } from "lucide-react";

const JawlineFillerSidebar = () => {
  return (
    <div className="space-y-6">
      ...
      >
        ...
        <div className="space-y-4">
          ...
          <GlanceStat icon={<Calendar className="w-4 h-4" />} label="Results last" value="15–18 months" />
      ...
      >
        ...
        <div className="space-y-2">
          {[
            { tier: "1ml Jawline Filler", price: "£350" },
            { tier: "2ml Jawline Filler", price: "£650" },
            { tier: "HD Jawline Package", price: "£950" },
          ].map((item) => (
      ...
      >
        ...
        <p className="text-xs text-white/40 leading-relaxed mb-3">
          View real patient before and after results demonstrating jawline definition, jowl correction, and lower face contouring.
        </p>
        <Link
      ...
      >
        ...
        <p className="text-sm text-white/60 leading-relaxed italic">
          "I wanted a sharper jawline without looking obvious. Dr Haq was incredibly precise — the results are subtle but make a real difference to my profile."
        </p>
        <Link
          to="/testimonials"
...
export default JawlineFillerSidebar;
