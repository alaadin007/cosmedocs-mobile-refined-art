...
export const sitemapData: SitemapData = {
  pages: [
    ...
    { loc: `${baseUrl}/before-after/`, lastmod: currentDate, changefreq: 'weekly', priority: 0.7 },
    ...
    { loc: `${baseUrl}/research/filtered-face-project`, lastmod: currentDate, changefreq: 'monthly', priority: 0.6 },
