            ...
            >
              <div className="bg-white/5 backdrop-blur-sm rounded-3xl p-8 border border-white/10">
                ...
                <div className="text-center mt-8">
                  <h3 className="text-xl font-light text-white mb-4">Professional Ear Lobe Rejuvenation Results</h3>
                  <p className="text-white/70 font-light leading-relaxed">
                    This video demonstrates the immediate transformation possible with our ear lobe rejuvenation treatment. 
                    Using premium hyaluronic acid fillers, we restore volume and firmness to create naturally youthful-looking earlobes.
                  </p>
                </div>
              </div>
            </motion.div>
