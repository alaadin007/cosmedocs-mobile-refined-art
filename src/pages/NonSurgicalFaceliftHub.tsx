    ...
    <>
      ...
      <div className="min-h-screen bg-black text-white">
        ...
        <div className="sr-only" aria-hidden="true">
          ...
          <p>
            Endolaser, also known as Endolift, represents the most advanced non-surgical lifting technology in our portfolio. A micro-fibre optic laser cannula is inserted beneath the skin to deliver precise thermal energy that simultaneously tightens the skin, dissolves small pockets of stubborn fat, and stimulates deep collagen remodelling. At Cosmedocs, we have refined the Endolaser technique to target specific facial zones — jowls, under-eye bags, eyebrow lifting, and double chin — rather than performing a general all-over treatment. This targeted approach complements existing filler work without dissolving it, and is performed in partnership with our specialist clinic Priva Dr.
          </p>
          <p>
