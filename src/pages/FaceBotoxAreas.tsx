...
import { ArrowLeft, Eye, Frown, Smile, Sparkles, Zap } from "lucide-react";
          ...
          <div className="max-w-4xl mx-auto">
            ...
            >
              ...
              <div className="relative">
                <Sparkles className="absolute -top-4 -left-4 h-6 w-6 text-cyan-400 animate-pulse" />
                <Zap className="absolute -top-4 -right-4 h-6 w-6 text-purple-400 animate-pulse delay-300" />
              ...
              <div className="pt-4 space-x-4">
                ...
                <Button
                  ...
                  variant="outline"
                  className="border-white/20 bg-white/5 backdrop-blur-sm text-white hover:bg-white/10 rounded-full px-8 py-3 transition-all duration-300 hover:scale-105"
                >
                  Related Treatments
                </Button>
              </div>
