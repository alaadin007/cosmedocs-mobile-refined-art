...
const BeforeAfterLaserHairRemoval = () => {
  const seoData = generateSEOMetadata(
    "Laser Hair Removal Before & After Results | CosmeDocs",
    "View real laser hair removal before and after results from our Harley Street clinic. Permanent hair reduction with medical-grade laser technology.",
  ...
  return (
    <>
      <Helmet>
        ...
        <link rel="canonical" href="https://www.cosmedocs.co.uk/before-after/laser-hair-removal/" />
        <meta property="og:title" content={seoData.title} />
        <meta property="og:description" content={seoData.description} />
        <meta property="og:url" content="https://www.cosmedocs.co.uk/before-after/laser-hair-removal/" />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "@graph": [
              ...
              {
                "@type": "ImageGallery",
                "name": "Laser Hair Removal Before & After Results",
                "description": "Real patient laser hair removal results from CosmeDocs Harley Street",
                "url": "https://www.cosmedocs.co.uk/before-after/laser-hair-removal/"
              }
            ]
          })}
        </script>
      ...
      <div className="min-h-screen bg-neutral-900 overflow-x-hidden">
        <section className="relative overflow-hidden bg-gradient-to-br from-black via-neutral-900 to-neutral-800 pt-0 pb-16">
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6">
            <Breadcrumb
              ...
              currentPage="Laser Hair Removal"
            />
            <div className="max-w-3xl pt-6 pb-4">
              <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }}>
                <h1 className="text-4xl md:text-5xl font-light text-white mb-5 leading-tight tracking-tight">
                  Laser Hair Removal <span className="font-semibold text-[#C9A050]">Before & After</span>
                </h1>
                <p className="text-base md:text-lg text-white/50 leading-relaxed max-w-2xl font-light">
                  Real patient results showing progressive hair reduction with medical-grade laser technology. Each course is tailored to skin type, hair colour, and treatment area.
                </p>
              </motion.div>
            ...
            <div className="max-w-2xl">
              <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} viewport={{ once: true }}>
                <p className="text-white/50 text-base mb-8 leading-relaxed font-light">
                  Laser hair removal typically requires a course of 6–8 sessions. Our team will assess your suitability and recommend a treatment plan.
                </p>
        ...
        <div className="sr-only">
          <h2>Laser Hair Removal Before and After Gallery</h2>
          <p>Browse authentic laser hair removal before and after results from CosmeDocs Harley Street. Our medical-grade laser technology delivers permanent hair reduction for all skin types. Our aesthetics is invisible art — bold, natural, always your way.</p>
        </div>
      </div>
    </>
  );
...
export default BeforeAfterLaserHairRemoval;
