      ...
      <section className="py-20 bg-black">
        <div className="page-container">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              { title: "Botox", description: "Anti-wrinkle injections for frown lines, crows feet & forehead lines" },
              { title: "Dermal Fillers", description: "Restore volume and enhance facial features" },
              { title: "Lip Fillers", description: "Subtle enhancement for natural-looking fullness" },
              { title: "Non-Surgical Nose Job", description: "Reshape without surgery" },
              { title: "Skin Boosters", description: "Deep hydration and rejuvenation" },
              { title: "PDO Threads", description: "Lift and tighten for a youthful appearance" },
            ].map((treatment, index) => (
              <motion.div
                key={treatment.title}
