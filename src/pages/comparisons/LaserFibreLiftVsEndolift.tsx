...
const LaserFibreLiftVsEndolift = () => {
  return (
    <ComparisonPage
      ...
      optionB="Laser Fibre Lift — Endolaser Excel (2G dual-wave)"
      metaTitle="Laser Fibre Lift vs Endolift® — Head-to-Head Clinical Comparison | Cosmedocs"
      metaDescription="Laser Fibre Lift (2G dual-wavelength Endolaser Excel) vs Endolift® (1G 1470nm). Doctor-led comparison from Harley Street. Which is right for you?"
      ...
      topAnswer="Both treatments use the same core principle — intra-tissue laser fibre delivery. Endolift® (1G) uses a single 1470nm wavelength. Laser Fibre Lift at Cosmedocs uses Endolaser Excel — the 2G dual-wavelength approach combining 980nm + 1470nm through one 200µm micro-fibre. If your concern is combined jowl / double chin / skin laxity, the 2G approach is clinically stronger in one pass. For pure micro-tightening, both are effective."
      rows={[
        { attribute: "Common name", optionA: "Endolift®", optionB: "Laser Fibre Lift / Endolaser Excel" },
      ...
      whenB="Choose Laser Fibre Lift (Endolaser Excel 2G) when the treatment plan needs to address BOTH skin laxity AND small pockets of stubborn fat — most commonly double chin, jowls, pre-jowl sulcus and early neck laxity. The dual-wavelength approach handles both in one insertion point, doctor-led, at a lower price point."
      bottomLine="They're the same family of treatment — Endolift® was the pioneer, Laser Fibre Lift with Endolaser Excel is the second-generation evolution. For most UK patients over 35 asking about laser fibre lifting, the 2G approach delivers more per pass. If you're comparing quotes for London, the price gap alone (£450 vs £1,500+ per zone) makes the 2G route worth a consultation before you commit."
      faqs={[
        {
          question: "Is Laser Fibre Lift the same as Endolift®?",
          answer:
            "They belong to the same treatment family and use the same intra-tissue laser fibre principle. Endolift® is the branded 1G device (1470nm only). Laser Fibre Lift at Cosmedocs — delivered as Endolaser Excel — is the 2G dual-wavelength (980nm + 1470nm) evolution of the same idea.",
        },
        {
        ...
        },
        {
          ...
          answer:
            "1G Endolift® pricing has historically included branded-device licensing. The 2G Endolaser Excel protocol is delivered on independently certified equipment, so the fee reflects clinical cost more closely — from £450 per zone versus £1,500+ for legacy Endolift® in the UK.",
        },
        {
      ...
      relatedLinks={[
        { label: "Endolaser Excel — full treatment page", path: "/treatments/endolaser/" },
