...
const Row = ({ category, index }: { category: Category; index: number }) => {
  ...
  return (
    ...
    >
      ...
      <div
        ref={scroller}
        className="flex gap-4 sm:gap-5 overflow-x-auto pb-4 px-5 sm:px-8 overscroll-x-contain [touch-action:pan-y] [-webkit-overflow-scrolling:touch] [scroll-behavior:smooth] [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden"
      >
