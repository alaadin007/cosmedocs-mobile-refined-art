...
const categories: Category[] = [
  {
    ...
    cards: [
      ...
      { title: "ScarTox — Scar Repair", tagline: "Tummy tuck · C-section · mommy makeover · breast scars. Multi-modality protocol: ScarTox (botulinum), RF microneedling and polynucleotides — softening, flattening and fading in one clinical pathway.", href: "/treatments/scar-repair-scartox/", bg: "bg-gradient-to-br from-[#1a1a1a] via-[#2a1d10] to-[#3a2d10]", badge: "New" },
