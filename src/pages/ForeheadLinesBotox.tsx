            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              >
                <h1 className="text-5xl md:text-6xl font-bold mb-8 leading-tight text-white">
                  <span className="text-purple-300">Forehead Lines Botox London</span>
          ...
          <div className="page-container">
            ...
            >
              ...
              <p className="text-gray-300 max-w-3xl mx-auto text-lg">
                Forehead lines botox targets the frontalis muscle that creates horizontal wrinkles across your forehead when raising eyebrows or expressing surprise. 
                Our invisible art approach smooths these lines while preserving natural brow movement and expression.
              </p>
            </motion.div>
