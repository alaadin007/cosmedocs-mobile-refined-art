...
const faqs = [
  {
    ...
    answer:
      "Endolift® pioneered laser fibre lifting in the mid-2010s using a single 1470nm diode. Cosmedocs offers Endolaser Excel — a second-generation dual-wavelength (980nm + 1470nm) laser fibre lift delivered under one fibre, doctor-led on Harley Street. It targets the same clinical outcome (skin tightening, jawline definition, sub-mental lift) with deeper collagen contraction per pass and typically longer results.",
  },
  {
    question: "What is the difference between Endolift® and Endolaser Excel?",
    answer:
      "Endolift® uses a single 1470nm wavelength. Endolaser Excel is a 2G evolution combining 980nm (vascular/adipose) and 1470nm (water/collagen) through the same optical fibre. In practice this means one pass tightens skin AND melts small pockets of stubborn fat — useful for double chin, jowls and pre-jowl sulcus.",
  },
  {
    question: "How much does the Endolift® alternative cost at Cosmedocs?",
    answer:
      "Endolaser Excel starts from £450 per zone. Full-face + neck packages are quoted at consultation. Endolift® in the UK typically ranges £1,500–£3,500 per zone; our doctor-led 2G protocol is priced transparently and includes 3-month review.",
  },
  {
    question: "Is Endolaser Excel FDA / CE approved?",
    answer:
  ...
  {
    question: "Endolift® vs Endolaser Excel — which lasts longer?",
    answer:
  ...
  },
  {
    ...
    answer:
      "Yes. Endolaser Excel is our preferred protocol for sub-mental fullness because the 980nm component addresses the adipose layer while 1470nm tightens the overlying skin — a single-pass solution that Endolift® typically requires layered treatments to match.",
  },
];
...
const EndoliftAlternative = () => {
  return (
    <>
      <Helmet>
        <title>Endolift Alternative UK — Endolaser Excel (2G) at Harley Street | Cosmedocs</title>
        <meta
          name="description"
          content="Looking for an Endolift® alternative in the UK? Endolaser Excel is the second-generation dual-wavelength laser fibre lift — doctor-led at Harley Street. From £450."
        />
        <meta name="robots" content="index, follow, max-image-preview:large" />
        <link rel="canonical" data-rh="true" href={canonical} />
        <meta property="og:title" content="Endolift Alternative — Endolaser Excel 2G | Cosmedocs" />
      ...
      <MedicalArticleSchema
        path={path}
        headline="Endolift® Alternative UK — Endolaser Excel (2G Dual-Wavelength Laser Fibre Lift)"
      ...
      <div className="bg-black text-white">
        ...
        <section className="relative overflow-hidden py-16 md:py-24">
          ...
          <div className="relative max-w-4xl mx-auto px-4 sm:px-6 text-center">
            ...
            <p className="text-lg md:text-xl text-white/70 font-light max-w-2xl mx-auto leading-relaxed">
              Endolift® pioneered laser fibre lifting in the mid-2010s. <strong className="text-white">Endolaser Excel</strong> is the
        ...
        <section className="max-w-4xl mx-auto px-4 sm:px-6 pb-12">
          <div className="bg-white/[0.03] border-l-4 border-[#C9A050] p-6 md:p-8 rounded-r-lg">
            ...
            <p className="text-base md:text-lg text-white/85 leading-relaxed" data-speakable>
              If you're searching for an Endolift® alternative in the UK, Endolaser Excel is the second-generation
        ...
        <section className="max-w-4xl mx-auto px-4 sm:px-6 pb-16">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="bg-gradient-to-br from-[#1a140a] to-black border border-[#C9A050]/40 rounded-2xl p-6">
              ...
              <h3 className="text-2xl font-light text-white mb-3">Endolaser Excel</h3>
        ...
        <section className="bg-white/[0.02] border-y border-white/10 py-14 md:py-20">
          <div className="max-w-4xl mx-auto px-4 sm:px-6">
            <h2 className="text-3xl md:text-4xl font-extralight mb-8 tracking-tight">Side-by-side: Endolift® vs Endolaser Excel</h2>
              ...
              <table className="w-full text-sm">
                <thead className="bg-white/[0.04]">
                  <tr>
                    ...
                    <th className="text-left px-4 py-3 font-medium text-[#C9A050]">Endolaser Excel (2G)</th>
                  </tr>
                </thead>
                <tbody>
        ...
        <section className="max-w-4xl mx-auto px-4 sm:px-6 py-14 md:py-20">
          <h2 className="text-3xl md:text-4xl font-extralight mb-8 tracking-tight">When Endolaser Excel is the better choice</h2>
        ...
        <section className="bg-gradient-to-b from-black to-[#0a0805] py-16 border-t border-white/10">
          <div className="max-w-3xl mx-auto px-4 sm:px-6 text-center">
            ...
            >
              Book your Endolaser Excel consultation <ArrowRight className="w-4 h-4" />
            </Link>
          </div>
        </section>
      </div>
