...
const treatments = [
  {
    title: 'Liquid Facelift — تجديد الوجه الكامل',
...
const comparisonData = [
  ...
  { treatment: 'Liquid Facelift', gulf: '$3,000–$5,000', london: 'من £1,250' },
      ...
      <div className="min-h-screen bg-black text-white" dir="rtl">
        ...
        <section className="max-w-4xl mx-auto px-4 py-12">
          <div className="text-xs text-white/30 leading-relaxed space-y-4">
            ...
            <p>
              تشمل خدماتنا التجميلية: حقن البوتوكس لخطوط الجبهة والعبوس وحول العينين، فيلر الشفاه الطبيعي بدون مبالغة، نحت خط الفك والذقن باستخدام فيلر الهيالورونيك، علاج الهالات الداكنة تحت العين، تجديد الوجه الكامل باستخدام تقنية Liquid Facelift الحصرية، وعلاجات تحفيز الكولاجين مثل Profhilo والبولينوكليوتيدات. كل هذه العلاجات يقوم بها أطباء متخصصون مسجلون في مجلس الأطباء البريطاني GMC، وليس ممرضات أو فنيين.
            </p>
            <p>
