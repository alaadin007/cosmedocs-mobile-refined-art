          ...
          <div className="page-container relative z-10">
            <div className="max-w-6xl">
              ...
              >
                ...
                >
                  <span className="block text-white/95 font-thin">Jaw-Dropping</span>
                  <span className="block text-white font-light">Jawline</span>
                  <span className="block text-white/85 text-5xl md:text-6xl italic font-extralight mt-2">Sculpting</span>
                </motion.h1>
                ...
                >
                  <p className="text-2xl md:text-3xl text-white/90 font-extralight leading-relaxed">
                    Slimmer, sleeker & sharper jawline enhancement. Natural HD jawline sculpting that frames your face with perfect proportions.
                  </p>
                  <div className="flex items-center space-x-8 text-xl">
                    <div className="bg-white/15 backdrop-blur-lg rounded-full px-8 py-4 border border-white/20">
                      <span className="text-white font-light">Natural HD Package £950</span>
                    </div>
