...
const HeroSection = () => <section className="pt-28 pb-16 px-4 md:px-8 text-center">
    <motion.div className="max-w-5xl mx-auto" initial="hidden" animate="visible" variants={fadeIn} transition={{
    duration: 0.5
  }}>
      <div className="mb-6">
...
const MissionSection = () => <section className="py-16 px-4 md:px-8 bg-gray-500">
...
const TrainingSection = () => <section className="py-16 bg-zinc-900 px-4 md:px-8">
    <div className="max-w-5xl mx-auto">
      ...
      once: true
        ...
        }].map((workshop, index) => <div key={index} className="bg-zinc-800 p-6 rounded-lg hover:bg-zinc-700 transition-colors border border-amber-500/10">
...
const EligibilitySection = () => <section className="py-16 px-4 md:px-8 bg-gray-500">
    <div className="max-w-4xl mx-auto">
      <motion.div className="bg-zinc-800 p-8 rounded-lg" initial={{
      opacity: 0,
      scale: 0.95
    }} whileInView={{
      opacity: 1,
...
const TerritoryProtectionSection = () => <section className="py-16 px-4 md:px-8">
    <div className="max-w-5xl mx-auto">
      <motion.div initial={{
      opacity: 0
    }} whileInView={{
      ...
      once: true
        ...
        }].map((territory, index) => <div key={index} className="bg-zinc-800 p-5 rounded-lg text-center">
...
const PricingSection = () => <section className="py-16 bg-zinc-900 px-4 md:px-8">
    <div className="max-w-4xl mx-auto">
      <motion.div initial={{
      opacity: 0,
      y: 30
...
const FAQSection = () => <section className="py-16 px-4 md:px-8">
