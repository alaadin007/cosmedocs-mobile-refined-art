          ...
          <div className="page-container">
            ...
            >
              ...
              <p className="text-gray-300 max-w-3xl mx-auto mb-8">
                ...
                causing them to relax. This <a href="https://www.fda.gov/drugs/postmarket-drug-safety-information-patients-and-providers/onabotulinumtoxina-marketed-botoxbotox-cosmetic-abobotulinumtoxina-marketed-dysport-and" target="_blank" rel="noopener noreferrer" className="text-purple-300 hover:text-purple-200 underline">FDA-approved treatment</a> has been safely used for both medical and 
              ...
              <Accordion type="single" collapsible className="w-full">
                <AccordionItem value="safety" className="border-gray-700">
                  ...
                  <AccordionContent className="text-gray-300">
                    <strong>Botox</strong> is approved by the <a href="https://www.fda.gov/drugs/postmarket-drug-safety-information-patients-and-providers/onabotulinumtoxina-marketed-botoxbotox-cosmetic-abobotulinumtoxina-marketed-dysport-and" target="_blank" rel="noopener noreferrer" className="text-purple-300 hover:text-purple-200 underline">Food & Drug Administration</a> in the US and the UK (MHRA). 
