            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                <div className="bg-black rounded-lg p-6">
                  ...
                  <p className="text-gray-400 text-sm">治疗后立即可见面部提升效果，轮廓更加紧致年轻</p>
                </div>
                <div className="bg-black rounded-lg p-6">
                  <h4 className="text-white font-semibold mb-3">持续改善</h4>
                  <p className="text-gray-400 text-sm">蛋白线刺激胶原蛋白生成，效果持续改善6-12个月</p>
                </div>
                <div className="bg-black rounded-lg p-6">
                  <h4 className="text-white font-semibold mb-3">安全可靠</h4>
                  <p className="text-gray-400 text-sm">PDO材料安全可吸收，无异物残留，恢复期短</p>
                </div>
              </div>
              
              <p className="text-purple-400 text-xl font-bold">PDO线雕价格：£800-1500（根据使用线材数量而定）</p>
            </motion.div>
          </div>
        </section>
              ...
              {[
                {
                  name: "李同学",
                  treatment: "瘦脸针 + 鼻部微整",
                  feedback: "在伦敦读书三年，一直想做医美但担心效果不自然。Cosmedocs的医生非常理解亚洲人的审美需求，做出来的效果特别自然，同学们都说我变漂亮了但又说不出哪里变了，这就是我想要的效果！",
                  location: "伦敦政经学院"
                },
                {
                  name: "张女士",
                  treatment: "全脸玻尿酸 + PDO线雕",
                  feedback: "工作压力大让我看起来老了很多，朋友推荐来Cosmedocs。医生根据我的脸型设计了个性化方案，现在看起来年轻了至少5岁，老公都说我越来越有女人味了。服务也很贴心，有中文沟通无障碍。",
                  location: "金融城白领"
                },
                {
                  name: "王博士",
                  treatment: "下巴塑形 + 抗皱治疗",
                  feedback: "作为医生我对医美要求很高，Cosmedocs的专业程度让我很放心。他们使用的都是最好的产品，技术也很精湛。现在的我更自信了，感觉整个人的气质都提升了不少。",
                  location: "NHS医生"
                }
              ...
              {[
                {
                  step: "01",
                  title: "中文预约",
                  description: "通过微信、电话或官网预约，支持中文沟通"
                },
                {
                  step: "02", 
                  title: "面诊分析",
                  description: "专业医生面对面咨询，制定个性化治疗方案"
                },
                {
                  step: "03",
                  title: "安全治疗",
                  description: "使用顶级设备和产品，确保治疗安全有效"
                },
                {
                  step: "04",
                  title: "贴心随访",
                  description: "治疗后专业护理指导，定期回访跟踪效果"
                }
              ].map((step, index) => (
                <motion.div
                  key={step.step}
                ...
                <div className="space-y-6">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-400 text-sm">地铁Oxford Circus站步行5分钟</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-400 text-sm">周一至周六 9:00-18:00</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-400 text-sm">支持中文邮件咨询</p>
                    </div>
                  </div>
                </div>
              </motion.div>
