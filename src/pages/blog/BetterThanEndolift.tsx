...
const BetterThanEndolift = () => {
  return (
    <ComparisonPage
      ...
      optionA="Endolift® (1G)"
      optionB="Endolaser Excel (2G)"
      metaTitle="Better Than Endolift? The Second-Generation Laser Fibre Lift Explained | Cosmedocs"
      metaDescription="Is there something better than Endolift®? The 2G evolution — Endolaser Excel — uses dual 980nm + 1470nm through one fibre. Doctor-led on Harley Street."
      ...
      topAnswer="Endolift® pioneered the category with a single 1470nm diode fibre — a real breakthrough. Endolaser Excel is the second-generation dual-wavelength evolution: 980nm + 1470nm through one 200µm fibre, delivered doctor-led on Harley Street. For patients wanting jawline lift AND small-fat remodelling (double chin, jowls) in one pass, the 2G approach outperforms 1G. For pure fine tightening, both work well."
      rows={[
      ...
      whenB="Endolaser Excel is the better choice when the treatment plan has to address BOTH skin laxity AND small pockets of stubborn fat in one pass — most commonly double chin, jowls and pre-jowl sulcus. The 980nm channel targets the adipose layer while 1470nm tightens the overlying skin. It's also better value at £450 per zone versus £1,500+ for legacy Endolift®."
      bottomLine="'Better' depends on what you're treating. For pure micro-tightening, both generations deliver. For combined lift + small-fat remodelling — the majority of patients over 35 asking about laser fibre lifting — the 2G dual-wavelength approach is clinically stronger in a single pass. Add doctor-led delivery, Harley Street address, and 3× the price advantage, and Endolaser Excel is our recommended path for UK patients researching Endolift® in 2026."
      faqs={[
        {
          question: "Is Endolaser Excel actually better than Endolift®?",
          answer:
        ...
        {
          question: "How long do Endolaser Excel results last vs Endolift®?",
          answer:
        ...
        {
          question: "Why is Endolaser Excel cheaper than Endolift®?",
          answer:
        ...
        {
          question: "Can I switch from Endolift® to Endolaser Excel?",
          answer:
            "Yes. Patients previously treated with 1G Endolift® often top up with Endolaser Excel 12–18 months later to add deeper adipose remodelling, particularly for jowl and pre-jowl definition.",
        },
      ]}
      relatedLinks={[
        ...
        { label: "Endolaser Excel — treatment page", path: "/treatments/endolaser/" },
