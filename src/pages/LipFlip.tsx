...
import { Check, Clock, Calendar, Activity, Syringe } from "lucide-react";
    ...
    <>
      ...
      <div className="bg-black text-white">
        ...
        <div className="sr-only">
          ...
          <p>Cosmedocs offers professional lip flip botox treatments for natural upper lip enhancement. Our experienced cosmetic doctors use advanced botulinum toxin injection techniques to create fuller-looking lips. Located in prestigious Harley Street, our clinic provides comprehensive lip assessments and personalized treatment plans.</p>
        </div>
      </div>
    </>
  );
