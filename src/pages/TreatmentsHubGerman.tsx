...
const categories = [
  ...
  { title: 'Dermal Filler', subtitle: 'Volumen, Struktur & Kontur', desc: 'Hyaluronsäure-Filler für natürliche Volumenwiederherstellung und Gesichtskonturierung.', link: '/de/behandlungen/hyaluronsaeure/', items: ['Lippenunterspritzung', 'Wangen-, Kinn- & Kinnlinienfiller', 'Nasen-Filler (nicht-chirurgisch)', 'Augenringfiller', 'Liquid Facelift'] },
