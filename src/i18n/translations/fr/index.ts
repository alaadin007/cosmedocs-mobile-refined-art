  ...
  pages: {
    ...
    contact: {
      ...
      content: {
        ...
        heroSubtitle: "Que vous souhaitiez réserver une consultation, poser une question ou simplement en savoir plus sur nos traitements — nous sommes là pour vous aider. Contactez-nous comme il vous convient.",
        ...
        askQuestionDesc: "Envoyez-nous votre question directement et notre équipe vous répondra dans les plus brefs délais — généralement dans les heures qui suivent pendant les heures d'ouverture.",
        formName: 'Nom',
        ...
        discreteText: "Aucune signalétique extérieure. Aucun logo de clinique sur la porte. Notre emplacement à Harley Street est volontairement non identifié — votre vie privée est absolue. Approuvé par des personnalités publiques, des célébrités et des patients de premier plan qui exigent une confidentialité totale.",
        ...
        aiDescription: "Obtenez des réponses instantanées sur les traitements, les tarifs et la réservation. Notre assistant IA est formé sur l'ensemble de notre portefeuille de traitements et peut vous aider à trouver exactement ce dont vous avez besoin.",
      },
    },
    about: {
      slug: 'a-propos',
