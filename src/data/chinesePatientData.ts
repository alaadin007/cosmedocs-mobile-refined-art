...
export const chineseData: PatientPageData = {
  ...
  haMakeover: {
    title: "什么是 Liquid Facelift？",
    subtitle: "玻尿酸综合年轻化",
    description: "Liquid Facelift 是一种系统性方案，而不是单点注射。它结合玻尿酸注射进行结构支撑、体积恢复和皮肤状态改善。",
  ...
  pricing: {
    ...
    comparison: [
      ...
      { treatment: "Liquid Facelift", local: "¥20,000–¥40,000", cosmedocs: "From £1,250" },
  ...
  faq: {
    ...
    items: [
      ...
      { q: "什么是 Liquid Facelift（玻尿酸综合年轻化）？", a: "Liquid Facelift 是一种系统性方案，结合玻尿酸注射进行结构支撑、体积恢复和皮肤状态改善，让脸看起来更年轻、更轻盈，但没有'做过'的痕迹。" },
  ...
  seoText: "Cosmedocs 伦敦哈雷街华人医美诊所，自2007年起为华语患者提供专业医美服务，包括瘦脸Botox咬肌注射、小腿瘦肌Calf Reduction、玻尿酸综合年轻化Liquid Facelift、非手术鼻整形、面部填充等。曾与Nihao Magazine你好杂志深度合作，是伦敦最早与华人社区建立信任关系的医美诊所之一。",
  keywords: "伦敦华人医美诊所, 华语医美, 瘦脸 Botox, 咬肌 Botox, Masseter Botox, 小腿瘦肌, 自然医美, 医生主导医美, 伦敦哈雷街医美, Liquid Facelift",
};
