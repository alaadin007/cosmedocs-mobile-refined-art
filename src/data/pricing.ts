...
export const fillersAntiAgeingPricing: PricingSection = {
  ...
  items: [
    ...
    { title: "Cheek Filler — Swiss Teoxane Ultradeep (1.2ml)", price: "£350", link: "/treatments/cheek-filler/" },
    { title: "Cheek Filler — Swiss Teoxane Ultradeep (1.8ml)", price: "£500", link: "/treatments/cheek-filler/" },
    { title: "Cheek Filler — Swiss Teoxane Ultradeep (2.4ml)", price: "£700", link: "/treatments/cheek-filler/" },
...
export const fillersContouringPricing: PricingSection = {
  ...
  items: [
    ...
    { title: "Non-Surgical Nose Job Plan — by Dr Haq (PCL Threads + Filler)", price: "£950", description: "Repeat visits within 18 months £500", link: "/treatments/nose-filler/" },
    { title: "Nose Job Repeat Visit (within 18 months)", price: "£500", link: "/treatments/nose-filler/" },
