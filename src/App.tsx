...
import VoiceConsultationWidget from "./components/voice/VoiceConsultationWidget";
...
const FaceBotoxArabic = lazy(() => import("./pages/FaceBotoxArabic"));
const FaceBotoxFrench = lazy(() => import("./pages/FaceBotoxFrench"));
const FaceBotoxSpanish = lazy(() => import("./pages/FaceBotoxSpanish"));
const LipFillersArabic = lazy(() => import("./pages/LipFillersArabic"));
...
const DermalFillersArabic = lazy(() => import("./pages/DermalFillersArabic"));
const DermalFillersFrench = lazy(() => import("./pages/DermalFillersFrench"));
const DermalFillersSpanish = lazy(() => import("./pages/DermalFillersSpanish"));
const JawlineFillerArabic = lazy(() => import("./pages/JawlineFillerArabic"));
const JawlineFillerFrench = lazy(() => import("./pages/JawlineFillerFrench"));
const JawlineFillerSpanish = lazy(() => import("./pages/JawlineFillerSpanish"));
const JawlineFillerChinese = lazy(() => import("./pages/JawlineFillerChinese"));
const ChinFillerArabic = lazy(() => import("./pages/ChinFillerArabic"));
const ChinFillerFrench = lazy(() => import("./pages/ChinFillerFrench"));
const ChinFillerSpanish = lazy(() => import("./pages/ChinFillerSpanish"));
const ChinFillerChinese = lazy(() => import("./pages/ChinFillerChinese"));
const TearTroughFillerArabic = lazy(() => import("./pages/TearTroughFillerArabic"));
const TearTroughFillerFrench = lazy(() => import("./pages/TearTroughFillerFrench"));
const TearTroughFillerSpanish = lazy(() => import("./pages/TearTroughFillerSpanish"));
const TearTroughFillerChinese = lazy(() => import("./pages/TearTroughFillerChinese"));
const SkinRejuvenationArabic = lazy(() => import("./pages/SkinRejuvenationArabic"));
const SkinRejuvenationFrench = lazy(() => import("./pages/SkinRejuvenationFrench"));
const SkinRejuvenationSpanish = lazy(() => import("./pages/SkinRejuvenationSpanish"));
const SkinRejuvenationChinese = lazy(() => import("./pages/SkinRejuvenationChinese"));
const PricesArabic = lazy(() => import("./pages/PricesArabic"));
const PricesFrench = lazy(() => import("./pages/PricesFrench"));
const PricesSpanish = lazy(() => import("./pages/PricesSpanish"));
const PricesChinese = lazy(() => import("./pages/PricesChinese"));
const ContactArabic = lazy(() => import("./pages/ContactArabic"));
const ContactFrench = lazy(() => import("./pages/ContactFrench"));
const ContactSpanish = lazy(() => import("./pages/ContactSpanish"));
const ContactChinese = lazy(() => import("./pages/ContactChinese"));
const AboutUsArabic = lazy(() => import("./pages/AboutUsArabic"));
const AboutUsFrench = lazy(() => import("./pages/AboutUsFrench"));
const AboutUsSpanish = lazy(() => import("./pages/AboutUsSpanish"));
const AboutUsChinese = lazy(() => import("./pages/AboutUsChinese"));
            ...
            <BrowserRouter>
              <AuthProvider>
                ...
                <Routes>
                  ...
                  {/* Arabic Routes */}
                  <Route path="/ar/" element={<Layout><Suspense fallback={<PageLoader />}><HomepageArabic /></Suspense></Layout>} />
